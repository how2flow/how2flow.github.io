---
permalink: /legacy/static-ip/
title: "[Linux] Ubuntu 고정 IP 할당"
excerpt: "우분투(>= 18.04) 에서 고정 ip 할당"
header:
  teaser: /assets/images/legacy/static-ip.png
categories:
  - Linux
tags:
  - linux static ip
...
```
<p align="center">
  <img src="/assets/images/legacy/net-dev-list.png" alt="net-dev-list" width="640" height="480"><br>
