...
(pca9685) $ python3 -m pip install --upgrade pip
(pca9685) $ python3 -m pip install adafruit-circuitpython-pca9685
```
<br>
...
(pca9685) $ sudo cp bindings/python/.lib/gpiod.* ~/.venv/pca9685/lib/python3.?/site-packages/
```
<br>
...
수정 완료 후 실행합니다.<br>
```
(pca9685) $ python3 pca9685_simpletest.py
```
