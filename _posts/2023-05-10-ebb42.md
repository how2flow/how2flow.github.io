...
title: "[klipper] ebb42 CAN V1.0 klipper 펌웨어 업데이트"
categories:
  - 3d-printer
tags:
  - can
...
연결이 확인 됐으면, 부트로더와 펌웨어를 설치합니다.<br>

#### MSC bootloader

EBB42 보드는 <span style="{{ site.code }}">stm32f072</span> 를 사용하고 있습니다.<br>
펌웨어 업데이트는 [MSC bootloader](https://www.klipper3d.org/Bootloaders.html#stm32f103stm32f072-with-msc-bootloader)를 사용해서 업데이트 합니다.<br>
...
$ sudo dfu-util -d 0483:df11 -a 0 -R -D build/MSCboot-STM32F072.bin -s0x08000000:leave
```
...
<p align="center">
  <img src="/assets/images/posts/ebb42withfan.jpg" alt="ebb42withfan" width="640" height="480"><br>
...
```
 1. 준비물 확인
 2. 호스트장치(odroid-m1)과 EBB42 보드를 usb로 연결
