...
title: "[klipper] EBB42 CAN v1.0 사용하기"
categories:
  - 3d-printer
  - odroid
tags:
...
EBB 보드의 CAN버스를 사용하려면 **USB to CAN** 과 같은 브릿지 제품을 사용해야 하는 불편함이 있습니다.<br>
...
klipper 설치는 [이전 포스팅](/posts/ebb42-1/)을 참고 하시면 됩니다.<br>
...
**프린터 동작 영상**
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=wR5RsvoSpDA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
**step y-axis를 제거한 후, 익스트루더 촬영 영상**
<iframe width="560" height="315" src="https://youtu.be/0PELl_1MluY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
