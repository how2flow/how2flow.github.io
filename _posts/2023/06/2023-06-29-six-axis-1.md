...
```
$ git clone https://github.com/how2flow/ros2_axis6
```
<br>

소스코드를 다운로드 받는다고 바로 프로그램들이 실행되지 않습니다.<br>
ros2 패키지 동작 환경을 [README](https://github.com/how2flow/ros2_axis6/blob/master/README.md) 를 참고하여 구성해 줍니다.<br>
<br>
...
다운로드 받은 ros2 패키지를 빌드하고 프로그램을 실행합니다.<br>
