...
categories:
- aspice
excerpt: Software requirements for the GICv3 and ITS driver, targeting Linux Kernel
  6.12.
header:
  teaser: /assets/images/posts/thumbnails/note.jpg
layout: single
title: '[ASPICE] GIC Software Requirements Specification (SWE.1)'
toc: true
redirect_from:
- /documents/aspice/gic-requirements-specification/
- /legacy/gic-requirements-specification/
- /documents/aspice/gic-requirements-specification
- /legacy/gic-requirements-specification
---
...
<img src="/assets/images/posts/contents/aspice/gic/gic-hardware-diagram.png" alt="GIC Hardware Diagram Placeholder" width="600">
...
<img src="/assets/images/posts/contents/aspice/gic/gic-sw-context-diagram.png" alt="GIC Software Context Diagram Placeholder" width="600">
...
<img src="/assets/images/posts/contents/aspice/gic/gic-domain-model.png" alt="GIC Domain Model" width="600">

## 4.2 Annex B. Quality Scenario
**Scenario: ITS Interrupt Translation & Latency**
<img src="/assets/images/posts/contents/aspice/gic/gic-quality-scenario.png" alt="ITS Interrupt Handling Scenario" width="600">
