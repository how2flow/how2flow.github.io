...
categories:
- aspice
excerpt: Software architectural design for the GICv3 and ITS driver, targeting Linux
  Kernel 6.12.
header:
  teaser: /assets/images/posts/thumbnails/note.jpg
layout: single
title: '[ASPICE] GIC Software Architectural Design (SWE.2)'
toc: true
redirect_from:
- /documents/aspice/gic-architecture-design/
- /legacy/gic-architecture-design/
- /documents/aspice/gic-architecture-design
- /legacy/gic-architecture-design
---
...
<img src="/assets/images/posts/contents/aspice/gic/gic-implementation-view.png" alt="GIC Implementation View" width="600">
...
<img src="/assets/images/posts/contents/aspice/gic/gic-runtime-view.png" alt="GIC Runtime View" width="600">
...
<img src="/assets/images/posts/contents/aspice/gic/gic-interaction-msi.png" alt="MSI Allocation Interaction" width="600">
