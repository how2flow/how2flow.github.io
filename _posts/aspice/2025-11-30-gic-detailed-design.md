...
categories:
- aspice
excerpt: Software detailed design for the GICv3 and ITS driver, targeting Linux Kernel
  6.12.
header:
  teaser: /assets/images/posts/thumbnails/note.jpg
layout: single
title: '[ASPICE] GIC Software Detailed Design (SWE.3)'
toc: true
redirect_from:
- /documents/aspice/gic-detailed-design/
- /legacy/gic-detailed-design/
- /documents/aspice/gic-detailed-design
- /legacy/gic-detailed-design
---
...
<img src="/assets/images/posts/contents/aspice/gic/gic-func-gic-of-init.png" alt="Call Graph: gic_of_init" width="600">
...
<img src="/assets/images/posts/contents/aspice/gic/gic-func-its-init.png" alt="Call Graph: its_init" width="600">
