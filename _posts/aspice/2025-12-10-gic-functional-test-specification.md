...
categories:
- aspice
excerpt: Functional test specification for the GICv3 and ITS driver, verifying module
  functions.
header:
  teaser: /assets/images/posts/thumbnails/note.jpg
layout: single
title: '[ASPICE] GIC Software Functional Test Specification (SWE.4)'
toc: true
redirect_from:
- /documents/aspice/gic-functional-test-specification/
- /legacy/gic-functional-test-specification/
- /documents/aspice/gic-functional-test-specification
- /legacy/gic-functional-test-specification
---
...
<img src="/assets/images/posts/contents/aspice/gic/gic-functional-test-env-diagram.png" alt="Test Environment Diagram" width="600">
