...
layout: single
title: '[ASPICE] SMMU Software Requirements Specification (SWE.1)'
toc: true
redirect_from:
- /documents/aspice/smmu-requirements-specification/
- /legacy/smmu-requirements-specification/
- /documents/aspice/smmu-requirements-specification
- /legacy/smmu-requirements-specification
---
...
<img src="/assets/images/posts/contents/aspice/smmu/smmu-hardware-diagram.png" alt="SMMU Hardware Diagram" width="600">
...
<img src="/assets/images/posts/contents/aspice/smmu/smmu-sw-context-diagram.png" alt="SMMU Software Context Diagram" width="600">
...
<img src="/assets/images/posts/contents/aspice/smmu/smmu-domain-model.png" alt="SMMU Domain Model" width="600">

## 4.2 Annex B. Quality Scenario
**Scenario: Context Fault Handling**
<img src="/assets/images/posts/contents/aspice/smmu/smmu-quality-scenario.png" alt="SMMU Fault Handling Scenario" width="600">
