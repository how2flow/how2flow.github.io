...
categories:
- aspice
excerpt: Software architectural design for the SMMUv3 driver, targeting Linux Kernel
  6.12.
header:
  teaser: /assets/images/posts/thumbnails/note.jpg
layout: single
title: '[ASPICE] SMMU Software Architectural Design (SWE.2)'
toc: true
redirect_from:
- /documents/aspice/smmu-architecture-design/
- /legacy/smmu-architecture-design/
- /documents/aspice/smmu-architecture-design
- /legacy/smmu-architecture-design
---
...
<img src="/assets/images/posts/contents/aspice/smmu/smmu-implementation-view.png" alt="SMMU Implementation View" width="600">
...
<img src="/assets/images/posts/contents/aspice/smmu/smmu-runtime-view.png" alt="SMMU Runtime View" width="600">
...
<img src="/assets/images/posts/contents/aspice/smmu/smmu-interaction-map.png" alt="DMA Map Interaction" width="600">
