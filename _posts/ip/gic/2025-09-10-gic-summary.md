...
layout: single
title: '[IP] GIC: Architecture Summary'
toc: true
redirect_from:
- /documents/gic/gic-summary/
- /legacy/gic-summary/
- /documents/gic/gic-summary
- /legacy/gic-summary
---
...
<div style="text-align: center;">
  <img src="/assets/images/posts/contents/ip/gic/gic_summary.png" alt="gic_summary" width="640" height="480"><br>
