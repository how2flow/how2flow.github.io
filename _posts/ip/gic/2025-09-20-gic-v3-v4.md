...
layout: single
title: '[IP] GICv3 & GICv4'
toc: true
redirect_from:
- /documents/gic/gic-v3-v4/
- /legacy/gic-v3-v4/
- /documents/gic/gic-v3-v4
- /legacy/gic-v3-v4
---
...
GIC stands for 'Generic Interrupt Controller'. For a summary, please refer to [GIC summary](/ip/gic-summary/).<br>
...
<div style="text-align: center;">
  <img src="/assets/images/posts/contents/ip/gic/gic_level_sens.png" alt="gic_level_sens" width="640" height="480"><br>
  <span style="{{ site.img }}">Picture [1] GIC level sensitive</span>
</div>
<br>

<div style="text-align: center;">
  <img src="/assets/images/posts/contents/ip/gic/gic_edge.png" alt="gic_edge" width="640" height="480"><br>
...
<div style="text-align: center;">
  <img src="/assets/images/posts/contents/ip/gic/gicv4-direct-injection.png" alt="GICv4 Direct Injection" width="640" height="480"><br>
