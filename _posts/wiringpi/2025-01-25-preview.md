...
layout: single
title: '[WiringPi] How to use wiringPi?'
toc: true
redirect_from:
- /documents/wiringpi/preview/
- /legacy/preview/
- /documents/wiringpi/preview
- /legacy/preview
---
...
<p align="center">
  <img src="/assets/images/posts/contents/wiringpi/rpi-header.png" alt="raspberrypi" width="320" height="240"><br>
...
Bold text will be covered in detail in the [wiringPi code part](/wiringpi/code/).
