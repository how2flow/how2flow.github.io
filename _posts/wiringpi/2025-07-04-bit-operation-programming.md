...
layout: single
title: '[WiringPi] bitwise operation'
toc: true
redirect_from:
- /documents/wiringpi/bit-operation-programming/
- /legacy/bit-operation-programming/
- /documents/wiringpi/bit-operation-programming
- /legacy/bit-operation-programming
---
## Intro
...
You checked about digital logic-gate in the [previous document](/wiringpi/logical-operation/).<br>
